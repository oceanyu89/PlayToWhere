...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.tabBarItem.image = [UIImage imageNamed:@"tab-explore_26x26_"];
        self.tabBarItem.selectedImage = [[UIImage imageNamed:@"tab-explore-select_26x26_"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    }
    return self;
}
- (void)viewDidLoad {
