...
#import "YUHYContainerViewController.h"
#import "YUHYScrollMenuView.h"

static const CGFloat kYUHYScrollMenuViewHeight = 40;

@interface YUHYContainerViewController () <UIScrollViewDelegate, YUHYScrollMenuViewDelegate>

@property (nonatomic, assign) CGFloat topBarHeight;
@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, strong) YUHYScrollMenuView *menuView;
@property(nonatomic,strong)UIButton *backBtn;
@end

@implementation YUHYContainerViewController
...
- (void)viewDidLoad {
    ...
    _contentScrollView.frame = CGRectMake(0,_topBarHeight + kYUHYScrollMenuViewHeight, self.view.frame.size.width, self.view.frame.size.height - (_topBarHeight + kYUHYScrollMenuViewHeight));
    ...
    // meunView
    _menuView = [[YUHYScrollMenuView alloc]initWithFrame:CGRectMake(0, _topBarHeight, self.view.frame.size.width, kYUHYScrollMenuViewHeight)];
...
#pragma mark -- YUHYScrollMenuView Delegate
