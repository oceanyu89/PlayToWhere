...
@protocol YUHYContainerViewControllerDelegate <NSObject>

- (void)containerViewItemIndex:(NSInteger)index currentController:(UIViewController *)controller;

@end

@interface YUHYContainerViewController : UIViewController

@property (nonatomic, weak) id <YUHYContainerViewControllerDelegate> delegate;
